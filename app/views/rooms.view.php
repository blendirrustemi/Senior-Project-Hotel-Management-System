  ...
  <section class="rooms section-title">
        ...
        <div class="calendar full-bleed">
                ...
                <form method="POST" action="">
                  ...
                  <div class="departure">
                  <p>Departure</p>
                    <input class="date-picker" name="depart_date" type="date">
                  </div>

                  <div class="guests">
                    <p>Guests</p>
                    <select name="guest_num" id="guest_num" class="guests-number">
                  ...
                  <button class="search-button" name="submit" type="submit">CHECK AVAILABILITY</button>
