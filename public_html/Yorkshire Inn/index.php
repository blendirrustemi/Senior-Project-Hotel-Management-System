...
<body>
  ...
  <div class="container">
    ...
    <section class="hero">
      ...
      <img src="assets/images/homepage/yorkshire.webp" alt="Yorkshire Inn">
    </section>
    ...
    <section class="amenities section-title">
      ...
      <div class="amenities-icons">
        ...
        <div class="amenities-icon-box">
          <img src="assets/images/icons/wifi.svg" alt="Icon">
          <p>WiFi</p>
        </div>

        <div class="amenities-icon-box">
          <img src="assets/images/icons/tv.svg" alt="Icon">
          <p>TV</p>
        </div>

        <div class="amenities-icon-box">
          <img src="assets/images/icons/wheelchair.svg" alt="Icon">
          <p>Accesibility</p>
        </div>

        <div class="amenities-icon-box">
          <img src="assets/images/icons/heat.svg" alt="Icon">
          <p>Heating</p>
        </div>

        <div class="amenities-icon-box">
          <img src="assets/images/icons/bath.svg" alt="Icon">
          <p>Bathroom</p>
        </div>

        <div class="amenities-icon-box">
          <img src="assets/images/icons/eco.svg" alt="Icon">
          <p>Eco-friendly</p>
        </div>
      ...
      <div class="reviews-container">
        <div class="review-box">
          <div class="review-box-top">
            <img src="assets/images/homepage/review-1.png" alt="review">
            <p>"A wonderful stay for
              my family!"</p>
          </div>
          <div class="review-box-bottom">
            <a href="https://www.facebook.com/theyorkshireinn"><img src="assets/images/icons/facebook-red.svg" alt="facebook"></a>
        ...
        <div class="review-box">
          <div class="review-box-top">
            <img src="assets/images/homepage/review-2.png" alt="review">
        ...
        <div class="review-box">
          <div class="review-box-top">
            <img src="assets/images/homepage/review-3.png" alt="review">
